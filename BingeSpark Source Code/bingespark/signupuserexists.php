...
<body style="background-color:#292826;">
    ...
    <div class="container">
        ...
        <!-- <p>
        <h2 style="color:gold; font-size:200%;"> Please log in, sign up or continue as guest </h1>
            </p> -->


        <p>
        <h2 style="color:gold; font-size:200%;"> Sorry, user exists with this email</h2>
            </p>

            <p>
            <a href='signup.php' class='btn btn-info'>Back to signup</a> <span> </span>
        </p>
